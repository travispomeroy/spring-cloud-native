...
import com.polarbookshop.catalogservice.domain.BookService.BookAlreadyExistsException;
...
class BookServiceTest {
	...
	void whenBookToReadDoesNotExistThenThrows() {
		...
		assertThatThrownBy(() -> bookService.viewBookDetails(bookIsbn)).isInstanceOf(BookNotFoundException.class)
